# INFO
Migrated to GitLab:
https://gitlab.com/kazam0180/iw1x-client
...
___
### Notes
- This project is no longer maintained by the original author (Raphael). The logo has been changed to reflect that.
- For cross-compilation, the project is now built with meson.
- If anyone can confirm or make the build system windows compatible, contact or open a pull request.
___
### Download
